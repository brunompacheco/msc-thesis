...
Not only the design of heuristic algorithms depends on the class of problems of interest, but the performance analysis is highly dependent on the instances that are expected to be fed to the heuristic.
