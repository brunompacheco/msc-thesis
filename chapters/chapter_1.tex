...
Many practical applications have a significant cost on the running time, to the point of implying a trade-off between running time and solution quality. 
In other words, \emph{heuristics} that can provide high-quality solutions in tractable time hold great value for many practical applications.
